...
This example shows how to create the TCP server based on the RT-Thread V3.1.5. Received and
...
Please install the following dependencies beforehand.
  - Middlewares/ReadlThread/RealThread.RT-Thread.3.1.5.pack    RT-Thread Software Components
...
&par Directory contents
  ...
  - ETH/ETH_RT-Thread_TcpServer/Source/apm32f10x_int.c     Interrupt handlers
  - ETH/ETH_RT-Thread_TcpServer/Source/main.c              Main program
  - ETH/ETH_RT-Thread_TcpServer/Source/board_DP83848.c     provides functions for configurate DP83848
