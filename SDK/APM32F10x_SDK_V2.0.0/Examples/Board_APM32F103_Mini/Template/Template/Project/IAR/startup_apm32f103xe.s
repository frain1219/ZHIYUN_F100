;
;/**
; * @file       startup_apm32f103xe.s
; *
; * @brief      CMSIS Cortex-M3 based Core Device Startup File for Device startup_apm32f103xe.s
; *
; * @version    V1.0.0
; *
; * @date       2026-03-01
...
__vector_table
        ...
        DCD     TMR8_BRK_IRQHandler               ; < TMR8 Break Interrupt
        DCD     TMR8_UP_IRQHandler                ; < TMR8 Update Interrupt
        DCD     TMR8_TRG_COM_IRQHandler           ; < TMR8 Trigger and Commutation Interrupt
        DCD     TMR8_CC_IRQHandler                ; < TMR8 Capture Compare Interrupt
        DCD     ADC3_IRQHandler                   ; < ADC3 global Interrupt
        DCD     EMMC_IRQHandler                   ; < EMMC global Interrupt
        ...
        DCD     DMA2_Channel4_5_IRQHandler        ; < DMA2 Channel 4 and Channel 5 global Interrupt
        DCD     0                                 ; Reserved
        DCD     USBD2_HP_CAN2_TX_IRQHandler       ; < USB Device 2 High Priority or CAN2 TX Interrupts
        DCD     USBD2_LP_CAN2_RX0_IRQHandler      ; < USB Device 2 Low Priority or CAN2 RX0 Interrupts
