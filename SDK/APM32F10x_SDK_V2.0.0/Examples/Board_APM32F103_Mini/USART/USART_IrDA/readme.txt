...
To use this example, the user needs to prepare two IrDA modules.
   ...
   PB10(USART2_TX) ---> 2# IrDA module TX
   PB11(USART2_RX) ---> 2# IrDA module TX

&par Directory contents

  - USART/USART_IrDA/Source/apm32f10x_int.c        Interrupt handlers
  - USART/USART_IrDA/Source/main.c                 Main program
