...
/** @defgroup IWDT_Reset_System_Macros System_Macros
  @{
*/
...
/**@} end of group IWDT_Reset_System_Macros*/

/** @defgroup IWDT_Reset_System_Variables System_Variables
  @{
*/
...
/**@} end of group IWDT_Reset_System_Variables*/

/** @defgroup IWDT_Reset_System_Functions System_Functions
  @{
*/
...
/**@} end of group IWDT_Reset_System_Functions */
