...
/*!< [31:16] USB Host Library main version V1.2.5*/
#define __USB_HOST_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __USB_HOST_VERSION_SUB1   (0x02) /*!< [23:16] sub1 version */
#define __USB_HOST_VERSION_SUB2   (0x05) /*!< [15:8]  sub2 version */
#define __USB_HOST_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __USB_HOST_VERSION        ((__USB_HOST_VERSION_MAIN << 24)\
                                        |(__USB_HOST_VERSION_SUB1 << 16)\
                                        |(__USB_HOST_VERSION_SUB2 << 8 )\
                                        |(__USB_HOST_VERSION_RC))
