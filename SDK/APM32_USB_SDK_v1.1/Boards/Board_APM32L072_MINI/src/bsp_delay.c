...
/** @addtogroup Board_APM32L072_MINI
  @{
*/

/** @defgroup APM32L072_MINI_Variables Variables
  @{
*/

__IO uint32_t delayTick;

/**@} end of group APM32L072_MINI_Variables*/

/** @defgroup APM32L072_MINI_Functions
  @{
*/
...
void APM_DelayInit(void)
{
    ...
    NVIC_EnableIRQRequest(SysTick_IRQn, 15);
}
...
/**@} end of group APM32L072_MINI_Functions */
/**@} end of group Board_APM32L072_MINI */
/**@} end of group Board */
