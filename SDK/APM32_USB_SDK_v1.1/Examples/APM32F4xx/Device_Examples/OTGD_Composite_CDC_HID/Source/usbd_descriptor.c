...
/** @defgroup OTGD_Composite_CDC_HID_Structures Structures
  @{
  */
...
/**@} end of group OTGD_Composite_CDC_HID_Structures*/

/** @defgroup OTGD_Composite_CDC_HID_Variables Variables
  @{
  */
...
/**@} end of group OTGD_Composite_CDC_HID_Variables*/
