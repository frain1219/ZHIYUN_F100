...
/** @addtogroup Examples
  * @brief OTGD WINUSB HS2 examples
  @{
  */
...
#endif
static USBD_DESC_INFO_T USBD_HS_WinUsbOsStrDescHandler(uint8_t usbSpeed);
...
#endif
    USBD_HS_WinUsbOsStrDescHandler,
...
uint8_t USBD_ConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    ...
    0x02,
    /* wMaxPacketSize: */
    USBD_WINUSB_HS_MP_SIZE & 0xFF,
    USBD_WINUSB_HS_MP_SIZE >> 8,
    /* bInterval: */
    0x00,
...
/*!
 * @brief     USB device HS WINUSB OS string descriptor
 *
 * @param     usbSpeed : usb speed
 *
 * @retval    usb descriptor information
