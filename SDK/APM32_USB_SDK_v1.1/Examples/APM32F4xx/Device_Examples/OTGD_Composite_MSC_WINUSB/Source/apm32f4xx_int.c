...
/** @defgroup OTGD_Composite_MSC_WINUSB_INT_Variables INT_Variables
  @{
  */

extern USBD_HANDLE_T usbDeviceHandler;

/**@} end of group OTGD_Composite_MSC_WINUSB_INT_Variables */

/** @defgroup OTGD_Composite_MSC_WINUSB_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group OTGD_Composite_MSC_WINUSB_INT_Functions */
