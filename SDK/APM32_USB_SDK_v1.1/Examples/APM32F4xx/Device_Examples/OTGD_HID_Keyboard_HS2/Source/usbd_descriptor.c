...
/** @addtogroup Examples
  * @brief OTGD HID Keyboard HS2 examples
  @{
  */

/** @addtogroup OTGD_HID_Keyboard_HS2
  @{
  */

/** @defgroup OTGD_HID_Keyboard_HS2_Macros Macros
  @{
*/

#define USBD_GEEHY_VID              12619
#define USBD_HS_PID                 0x107
...
/**@} end of group OTGD_HID_Keyboard_HS2_Macros*/

/** @defgroup OTGD_HID_Keyboard_HS2_Functions Functions
  @{
  */
...
/**@} end of group OTGD_HID_Keyboard_HS2_Functions */

/** @defgroup OTGD_HID_Keyboard_HS2_Structures Structures
  @{
  */
...
/**@} end of group OTGD_HID_Keyboard_HS2_Structures*/

/** @defgroup OTGD_HID_Keyboard_HS2_Variables Variables
  @{
  */
...
uint8_t USBD_ConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    ...
    0x03,
    /* wMaxPacketSize: */
    USBD_HID_IN_EP_SIZE & 0xFF,
    USBD_HID_IN_EP_SIZE >> 8,
    /* bInterval: */
    USBD_HID_HS_INTERVAL,
};
...
uint8_t USBD_DevQualifierDesc[USBD_DEVICE_QUALIFIER_DESCRIPTOR_SIZE] =
{
    ...
    0x00,
    0x00,
    USBD_HID_FS_MP_SIZE, /* In FS device*/
    0x01,
    0x00,
};

/**@} end of group OTGD_HID_Keyboard_HS2_Variables*/
...
/**@} end of group OTGD_HID_Keyboard_HS2_Functions */
/**@} end of group OTGD_HID_Keyboard_HS2 */
