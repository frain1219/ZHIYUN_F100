...
/** @addtogroup OTGD_Composite_WINUSB
  @{
  */

/** @defgroup OTGD_Composite_WINUSB_Macros Macros
  @{
*/

#define USBD_GEEHY_VID              12619
#define USBD_FS_PID                 0x0123
...
/**@} end of group OTGD_Composite_WINUSB_Macros*/

/** @defgroup OTGD_Composite_WINUSB_Functions Functions
  @{
  */
...
#endif
static USBD_DESC_INFO_T USBD_FS_WinUsbOsStrDescHandler(uint8_t usbSpeed);
...
/**@} end of group OTGD_Composite_WINUSB_Functions */

/** @defgroup OTGD_Composite_WINUSB_Structures Structures
  @{
  */
...
#endif
    USBD_FS_WinUsbOsStrDescHandler,
    USBD_OtherSpeedConfigDescHandler,
    USBD_DevQualifierDescHandler,
};

/**@} end of group OTGD_Composite_WINUSB_Structures*/

/** @defgroup OTGD_Composite_WINUSB_Variables Variables
  @{
  */
 ...
 */
uint8_t USBD_WinUsbOsString[USBD_WINUSB_OS_STRING_SIZE] =
{
    /* bLength */
    0x12,
    /* bDescriptorType */
...
uint8_t USBD_ConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    ...
    USBD_WINUSB1_INTERFACE_NUM,                          /* bFirstInterface */
    USBD_WINUSB1_INTERFACE_CNT,                          /* bInterfaceCount */
    0xFFU,                                              /* bFunctionClass: Vendor Specific */
    ...
    USBD_WINUSB1_INTERFACE_NUM,                          /* bInterfaceNumber: Number of Interface */
    ...
    USBD_WINUSB1_OUT_EP_ADDR,                            /* Endpoint address (OUT, address 1) */
    0x02,                                               /* Bulk endpoint type */
    WINUSB_FS_MAX_PACKET_SIZE & 0xFF,
    WINUSB_FS_MAX_PACKET_SIZE >> 8,
    0x00,                                               /* Polling interval in milliseconds */
    
    0x07,                                               /* Endpoint descriptor length = 7 */
    USBD_DESC_ENDPOINT,                                 /* Endpoint descriptor type */
    USBD_WINUSB1_IN_EP_ADDR,                             /* Endpoint address (IN, address 1) */
    0x02,                                               /* Bulk endpoint type */
    WINUSB_FS_MAX_PACKET_SIZE & 0xFF,
    WINUSB_FS_MAX_PACKET_SIZE >> 8,
    0x00,                                               /* Polling interval in milliseconds */
    ...
    0x08,                                               /* bLength: Interface Descriptor size */
    USBD_DESC_IAD,                                      /* bDescriptorType: */
    USBD_WINUSB2_INTERFACE_NUM,                          /* bFirstInterface */
    USBD_WINUSB2_INTERFACE_CNT,                          /* bInterfaceCount */
    0xFFU,                                              /* bFunctionClass: Vendor Specific */
    0x00U,                                              /* bFunctionSubClass */
    0x00U,                                              /* bInterfaceProtocol */
    USBD_DESC_STR_PRODUCT,                              /* iFunction */
    ...
    0x09,                                               /* bLength: Interface Descriptor size */
    USBD_DESC_INTERFACE,                                /* bDescriptorType: */
    USBD_WINUSB2_INTERFACE_NUM,                          /* bInterfaceNumber: Number of Interface */
    0x00,                                               /* bAlternateSetting: Alternate setting */
    0x02,                                               /* bNumEndpoints */
    0xFF,                                               /* bInterfaceClass: Vendor Specific */
    0x00,                                               /* bInterfaceSubClass : SCSI transparent*/
    ...
    0x07,                                               /* Endpoint descriptor length = 7 */
    USBD_DESC_ENDPOINT,                                 /* Endpoint descriptor type */
    USBD_WINUSB2_OUT_EP_ADDR,                            /* Endpoint address (OUT, address 1) */
    0x02,                                               /* Bulk endpoint type */
    WINUSB_FS_MAX_PACKET_SIZE & 0xFF,
    WINUSB_FS_MAX_PACKET_SIZE >> 8,
    0x00,                                               /* Polling interval in milliseconds */
    ...
    0x07,                                               /* Endpoint descriptor length = 7 */
    USBD_DESC_ENDPOINT,                                 /* Endpoint descriptor type */
    USBD_WINUSB2_IN_EP_ADDR,                             /* Endpoint address (IN, address 1) */
    0x02,                                               /* Bulk endpoint type */
    WINUSB_FS_MAX_PACKET_SIZE & 0xFF,
    WINUSB_FS_MAX_PACKET_SIZE >> 8,
    0x00,                                               /* Polling interval in milliseconds */
...
uint8_t USBD_DevQualifierDesc[USBD_DEVICE_QUALIFIER_DESCRIPTOR_SIZE] =
{
    ...
    0x00,
    0x00,
    WINUSB_FS_MAX_PACKET_SIZE, /* In FS device*/
    0x01,
    0x00,
};

/**@} end of group OTGD_Composite_WINUSB_Variables*/
...
/*!
 * @brief     USB device FS WINUSB OS string descriptor
 *
 * @param     usbSpeed : usb speed
 *
 * @retval    usb descriptor information
...
static USBD_DESC_INFO_T USBD_FS_WinUsbOsStrDescHandler(uint8_t usbSpeed)
{
    ...
    descInfo.desc = USBD_WinUsbOsString;
    descInfo.size = sizeof(USBD_WinUsbOsString);
...
/**@} end of group OTGD_Composite_WINUSB_Functions */
/**@} end of group OTGD_Composite_WINUSB */
