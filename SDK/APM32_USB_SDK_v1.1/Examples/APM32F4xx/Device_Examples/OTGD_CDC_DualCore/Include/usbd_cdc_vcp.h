...
/** @defgroup OTGD_CDC_DualCore_Enumerates Enumerates
  @{
  */
...
/**@} end of group OTGD_CDC_DualCore_Enumerates*/
...
extern USBD_CDC_INTERFACE_T USBD_CDC_INTERFACE_HS;
extern USBD_CDC_VCP_INFO_T gUsbHSVCP;
extern uint8_t hscdcTxBuffer[USBD_CDC_TX_BUF_LEN];
extern uint8_t hscdcRxBuffer[USBD_CDC_RX_BUF_LEN];

extern USBD_CDC_INTERFACE_T USBD_CDC_INTERFACE_FS;
extern USBD_CDC_VCP_INFO_T gUsbFSVCP;
extern uint8_t fscdcTxBuffer[USBD_CDC_TX_BUF_LEN];
extern uint8_t fscdcRxBuffer[USBD_CDC_RX_BUF_LEN];
