...
#include "usbd_cdc_class.h"
#include <stdio.h>
#include <string.h>

/** @addtogroup Examples
  * @brief OTGD CDC DualCore examples
  @{
  */
...
/** @defgroup OTGD_CDC_DualCore_Structures Structures
  @{
  */
...
/**@} end of group OTGD_CDC_DualCore_Structures*/
...
/**
 * @brief   HS Configuration descriptor
 */
uint8_t USBD_HSConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    /* bLength */
    0x09,
    /* bDescriptorType */
    ...
    USBD_DESC_ENDPOINT,
    /* bEndpointAddress */
    USBD_CDC_HS_DATA_OUT_EP_ADDR,
    /* bmAttributes */
    0x02,
    /* wMaxPacketSize: */
    USBD_CDC_HS_MP_SIZE & 0xFF,
    USBD_CDC_HS_MP_SIZE >> 8,
    /* bInterval: */
    0x00,
...
/**
 * @brief   FS Configuration descriptor
 */
uint8_t USBD_FSConfigDesc[USBD_FS_CONFIG_DESCRIPTOR_SIZE] =
{
    /* bLength */
    0x09,
    /* bDescriptorType */
    USBD_DESC_CONFIGURATION,
    /* wTotalLength */
    USBD_FS_CONFIG_DESCRIPTOR_SIZE & 0xFF,
    USBD_FS_CONFIG_DESCRIPTOR_SIZE >> 8,
...
static USBD_DESC_INFO_T USBD_HS_ConfigDescHandler(uint8_t usbSpeed)
{
    ...
    descInfo.desc = USBD_HSConfigDesc;
    descInfo.size = sizeof(USBD_HSConfigDesc);
...
static USBD_DESC_INFO_T USBD_FS_ConfigDescHandler(uint8_t usbSpeed)
{
    ...
    descInfo.desc = USBD_FSConfigDesc;
    descInfo.size = sizeof(USBD_FSConfigDesc);
