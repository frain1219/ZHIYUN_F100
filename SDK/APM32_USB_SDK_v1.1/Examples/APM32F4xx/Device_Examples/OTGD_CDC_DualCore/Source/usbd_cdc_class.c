...
/* CDC class handler */
USBD_CLASS_T USBD_HS_CDC_CLASS =
{
    /* Class handler */
    "Class HS CDC",
    NULL,
...
/* CDC class handler */
USBD_CLASS_T USBD_FS_CDC_CLASS =
{
    /* Class handler */
    "Class FS CDC",
    NULL,
...
static USBD_STA_T USBD_CDC_ClassInitHandler(USBD_INFO_T* usbInfo, uint8_t cfgIndex)
{
    ...
    switch (usbInfo->devSpeed)
    {
        case USBD_SPEED_FS:
            ...
            usbDevCDC->epCmdAddr = USBD_CDC_FS_CMD_EP_ADDR;
            usbDevCDC->epInAddr = USBD_CDC_FS_DATA_IN_EP_ADDR;
            usbDevCDC->epOutAddr = USBD_CDC_FS_DATA_OUT_EP_ADDR;
        ...
        default:
            ...
            usbDevCDC->epCmdAddr = USBD_CDC_HS_CMD_EP_ADDR;
            usbDevCDC->epInAddr = USBD_CDC_HS_DATA_IN_EP_ADDR;
            usbDevCDC->epOutAddr = USBD_CDC_HS_DATA_OUT_EP_ADDR;
