...
/** @defgroup OTGH_MSC_SDCard_INT_Variables INT_Variables
  @{
  */

extern USBD_HANDLE_T usbDeviceHandler;

/**@} end of group OTGH_MSC_SDCard_INT_Variables */

/** @defgroup OTGH_MSC_SDCard_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group OTGH_MSC_SDCard_INT_Functions */
