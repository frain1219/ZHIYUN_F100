...
/** @addtogroup Examples
  * @brief OTGD HID WakeUp examples
  @{
  */
...
/** @defgroup OTGD_HID_WakeUp_LowPower_Macros Macros
  @{
*/

#define DEBUG_USART    USART1

/**@} end of group OTGD_HID_WakeUp_LowPower_Macros*/

/** @defgroup OTGD_HID_WakeUp_LowPower_Enumerates Enumerates
  @{
  */
...
/**@} end of group OTGD_HID_WakeUp_LowPower_Enumerates*/

/** @defgroup OTGD_HID_WakeUp_LowPower_Variables Variables
  @{
  */
uint8_t WakeupEnable = 0;

extern USBD_HANDLE_T usbDeviceHandler;
/**@} end of group OTGD_HID_WakeUp_LowPower_Variables*/

/** @defgroup OTGD_HID_WakeUp_LowPower_Functions Functions
  @{
  */
    ...
    switch (userAppState)
    {
        ...
        case USER_APP_RUN:
            if(WakeupEnable)
            {
                ...
                USB_OTG_D_EnableRemoteWakeupSignal(usbDeviceHandler.usbDevice);

                APM_DelayMs(10);

                USB_OTG_D_DisableRemoteWakeupSignal(usbDeviceHandler.usbDevice);
            }
...
/**@} end of group OTGD_HID_WakeUp_LowPower_Functions */
