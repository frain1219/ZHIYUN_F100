...
/** @defgroup OTGH_MSC_HS2_INT_Variables INT_Variables
  @{
  */

extern USBH_HANDLE_T usbHostHandler;

/**@} end of group OTGH_MSC_HS2_INT_Variables */

/** @defgroup OTGH_MSC_HS2_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group OTGH_MSC_HS2_INT_Functions */
