...
/** @defgroup OTGH_HID_HS_IN_FS_INT_Variables INT_Variables
  @{
  */

extern USBH_HANDLE_T usbHostHandler;

/**@} end of group OTGH_HID_HS_IN_FS_INT_Variables */

/** @defgroup OTGH_HID_HS_IN_FS_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group OTGH_HID_HS_IN_FS_INT_Functions */
