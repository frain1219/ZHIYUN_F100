...
/** @defgroup OTGH_MSC_HS1_Macros Macros
  @{
*/

#define DEBUG_USART    USART1

/**@} end of group OTGH_MSC_HS1_Macros*/
...
/** @defgroup OTGH_MSC_HS1_Enumerates Enumerates
  @{
  */
...
/**@} end of group OTGH_MSC_HS1_Enumerates*/
...
int main(void)
{
    ...
    printf("USB Host MSC HS1 Application\r\n");
