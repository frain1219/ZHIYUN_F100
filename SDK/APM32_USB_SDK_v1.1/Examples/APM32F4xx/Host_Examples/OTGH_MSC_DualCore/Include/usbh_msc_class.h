...
/** @defgroup OTGH_MSC_DualCore_Structures Structures
  @{
  */
...
extern USBH_CLASS_T USBH_HS_MSC_CLASS;
extern USBH_CLASS_T USBH_FS_MSC_CLASS;


/**@} end of group OTGH_MSC_DualCore_Structures*/
