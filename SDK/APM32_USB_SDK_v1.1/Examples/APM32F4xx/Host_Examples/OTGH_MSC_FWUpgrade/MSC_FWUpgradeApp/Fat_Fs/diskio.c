...
)
{
    ...
    if (USBH_MSC_DevStatus(&gUsbHostFS, lun))
    {
        res = RES_OK;
    }
...
)
{
    ...
    if (USBH_MSC_DevRead(&gUsbHostFS, lun, sector, buff, count) == USBH_OK)
    {
        res = RES_OK;
    }
    else
    {
        USBH_MSC_ReadDevInfo(&gUsbHostFS, lun, &device);
...
)
{
    ...
    if (USBH_MSC_DevWrite(&gUsbHostFS, lun, sector, (BYTE*)buff, count) == USBH_OK)
    {
        res = RES_OK;
    }
    else
...
)
{
    ...
    switch (cmd)
    {
        ...
        case GET_SECTOR_SIZE:
            if (USBH_MSC_ReadDevInfo(&gUsbHostFS, lun, &device) == USBH_OK)
            {
