...
/** @defgroup DRD_MSC_CDC_DualCore_INT_Variables INT_Variables
  @{
  */
...
/**@} end of group DRD_MSC_CDC_DualCore_INT_Variables */

/** @defgroup DRD_MSC_CDC_DualCore_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group DRD_MSC_CDC_DualCore_INT_Functions */
