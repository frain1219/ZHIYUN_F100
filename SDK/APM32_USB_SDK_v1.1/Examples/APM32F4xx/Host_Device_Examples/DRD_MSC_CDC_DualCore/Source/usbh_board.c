...
void USBH_HardwareReset(USBH_INFO_T* usbInfo)
{
    if (usbInfo->hostSpeed == USBH_SPEED_FS)
    {
        ...
        /* Reset USB FS */
        RCM_EnableAHB2PeriphReset(RCM_AHB2_PERIPH_OTG_FS);
        RCM_DisableAHB2PeriphReset(RCM_AHB2_PERIPH_OTG_FS);
    }
    else if (usbInfo->hostSpeed == USBH_SPEED_HS)
    {
        ...
        /* Reset USB HS */
        RCM_EnableAHB1PeriphReset(RCM_AHB1_PERIPH_OTG_HS);
        RCM_DisableAHB1PeriphReset(RCM_AHB1_PERIPH_OTG_HS);
    }
}
