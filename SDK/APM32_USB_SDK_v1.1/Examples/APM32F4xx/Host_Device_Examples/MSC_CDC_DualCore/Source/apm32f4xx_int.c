...
/** @defgroup MSC_CDC_DualCore_INT_Variables INT_Variables
  @{
  */
...
/**@} end of group MSC_CDC_DualCore_INT_Variables */

/** @defgroup MSC_CDC_DualCore_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group MSC_CDC_DualCore_INT_Functions */
