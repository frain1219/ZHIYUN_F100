...
/** @defgroup USBD_Composite_CDC_HID_Macros Macros
  @{
*/

#define DEBUG_USART    USART1

/**@} end of group USBD_Composite_CDC_HID_Macros*/

/** @defgroup USBD_Composite_CDC_HID_Enumerates Enumerates
  @{
  */
...
/**@} end of group USBD_Composite_CDC_HID_Enumerates*/
