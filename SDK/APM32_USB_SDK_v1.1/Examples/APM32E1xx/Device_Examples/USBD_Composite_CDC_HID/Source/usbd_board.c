...
/** @addtogroup USBD_Composite_CDC_HID
  @{
  */

/** @defgroup USBD_Composite_CDC_HID_Variables Variables
  @{
  */

USBD_HANDLE_T usbDeviceHandler;

/**@} end of group USBD_Composite_CDC_HID_Variables*/

/** @defgroup USBD_Composite_CDC_HID_Functions Functions
  @{
  */
...
/**@} end of group USBD_Composite_CDC_HID_Functions */
/**@} end of group USBD_Composite_CDC_HID */
