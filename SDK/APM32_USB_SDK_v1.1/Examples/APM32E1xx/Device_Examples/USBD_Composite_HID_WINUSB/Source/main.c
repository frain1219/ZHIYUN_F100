...
/** @defgroup USBD_Composite_HID_WINUSB_Macros Macros
  @{
*/

#define DEBUG_USART    USART1

/**@} end of group USBD_Composite_HID_WINUSB_Macros*/

/** @defgroup USBD_Composite_HID_WINUSB_Enumerates Enumerates
  @{
  */
...
/**@} end of group USBD_Composite_HID_WINUSB_Enumerates*/
...
void USB_DevUserApplication(void)
{
    ...
    {
        case USER_APP_INIT:
            interval = USBD_Composite_CUSTOM_HID_ReadInterval(&gUsbDeviceFS);
            ...
            if (!APM_MINI_PBGetState(BUTTON_KEY1))
            {
                ...
                if (!APM_MINI_PBGetState(BUTTON_KEY1))
                {
                    if(i > 29)
                    {
                        ...
                        USBD_Composite_CUSTOM_HID_TxReport(&gUsbDeviceFS, (uint8_t*)report, 8);
                        APM_DelayMs(20);
                        report[2] = 0;
                        USBD_Composite_CUSTOM_HID_TxReport(&gUsbDeviceFS, (uint8_t*)report, 8);
                        APM_DelayMs(20);
