...
/** @addtogroup USBD_Composite_HID_WINUSB
  @{
  */

/** @defgroup USBD_Composite_HID_WINUSB_Variables Variables
  @{
  */

USBD_HANDLE_T usbDeviceHandler;

/**@} end of group USBD_Composite_HID_WINUSB_Variables*/

/** @defgroup USBD_Composite_HID_WINUSB_Functions Functions
  @{
  */
...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CUSTOM_HID_IN_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CUSTOM_HID_IN_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CUSTOM_HID_OUT_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CUSTOM_HID_OUT_EP_PMA_SIZE);

    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB_IN_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB_IN_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB_OUT_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB_OUT_EP_PMA_SIZE);
...
/**@} end of group USBD_Composite_HID_WINUSB_Functions */
/**@} end of group USBD_Composite_HID_WINUSB */
