...
/** @defgroup USBD_Composite_MSC_WINUSB_Macros Macros
  @{
*/

#define DEBUG_USART    USART1

/**@} end of group USBD_Composite_MSC_WINUSB_Macros*/

/** @defgroup USBD_Composite_MSC_WINUSB_Enumerates Enumerates
  @{
  */
...
/**@} end of group USBD_Composite_MSC_WINUSB_Enumerates*/
