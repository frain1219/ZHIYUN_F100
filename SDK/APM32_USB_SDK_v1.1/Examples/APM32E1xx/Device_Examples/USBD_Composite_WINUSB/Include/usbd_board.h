...
#define USBD_SUP_INTERFACE_MAX_NUM          2
...
/* WINUSB */
#define USBD_WINUSB_NUM                     0x2
#define WINUSB1                             0x0
#define WINUSB2                             0x1

#define USBD_WINUSB1_IN_EP_ADDR              0x81U
#define USBD_WINUSB1_IN_EP_PMA_SIZE          0xC0
#define USBD_WINUSB1_OUT_EP_ADDR             0x01U
#define USBD_WINUSB1_OUT_EP_PMA_SIZE         0x100

#define USBD_WINUSB2_IN_EP_ADDR              0x82U
#define USBD_WINUSB2_IN_EP_PMA_SIZE          0x140
#define USBD_WINUSB2_OUT_EP_ADDR             0x02U
#define USBD_WINUSB2_OUT_EP_PMA_SIZE         0x180

#define USBD_WINUSB1_INTERFACE_NUM               0x00
#define USBD_WINUSB1_INTERFACE_CNT               0x01

#define USBD_WINUSB2_INTERFACE_NUM               0x01
#define USBD_WINUSB2_INTERFACE_CNT               0x01
