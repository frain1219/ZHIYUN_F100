...
static USBD_STA_T USBD_FS_CDC_ItfInit(uint8_t cdcnum);
...
static USBD_STA_T USBD_FS_CDC_ItfInit(uint8_t cdcnum)
{
    ...
    USBD_Composite_CDC_ConfigRxBuffer(&gUsbDeviceFS, cdcRxBuffer[cdcnum], cdcnum);
    USBD_Composite_CDC_ConfigTxBuffer(&gUsbDeviceFS, cdcTxBuffer, 0, cdcnum);
