...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CDC1_DATA_IN_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CDC1_DATA_IN_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CDC1_DATA_OUT_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CDC1_DATA_OUT_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CDC1_CMD_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CDC1_CMD_EP_PMA_SIZE);

    USBD_ConfigPMA(&usbDeviceHandler, USBD_CDC2_DATA_IN_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CDC2_DATA_IN_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CDC2_DATA_OUT_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CDC2_DATA_OUT_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_CDC2_CMD_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_CDC2_CMD_EP_PMA_SIZE);
