...
/** @defgroup USBD_Composite_HID_MSC_Macros Macros
  @{
*/

#define DEBUG_USART    USART1

/**@} end of group USBD_Composite_HID_MSC_Macros*/

/** @defgroup USBD_Composite_HID_MSC_Enumerates Enumerates
  @{
  */
...
/**@} end of group USBD_Composite_HID_MSC_Enumerates*/
