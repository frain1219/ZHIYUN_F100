...
/** @addtogroup USBD_Composite_CDC_MSC
  @{
  */

/** @defgroup USBD_Composite_CDC_MSC_Macros Macros
  @{
*/
...
#define USBD_MSC_IN_EP_PMA_SIZE             0xC0
#define USBD_MSC_OUT_EP_ADDR                0x01U
#define USBD_MSC_OUT_EP_PMA_SIZE            0x100

#define USBD_CDC_DATA_IN_EP_ADDR                0x82U
#define USBD_CDC_DATA_IN_EP_PMA_SIZE            0x140
#define USBD_CDC_DATA_OUT_EP_ADDR               0x02U
#define USBD_CDC_DATA_OUT_EP_PMA_SIZE           0x180
#define USBD_CDC_CMD_EP_ADDR                    0x83U
#define USBD_CDC_CMD_EP_PMA_SIZE                0x1C0
...
/**@} end of group USBD_Composite_CDC_MSC_Macros*/

/** @defgroup USBD_Composite_CDC_MSC_Functions Functions
  @{
  */

/**@} end of group USBD_Composite_CDC_MSC_Functions */
/**@} end of group USBD_Composite_CDC_MSC */
