...
/** @addtogroup Examples
  * @brief USBD CUSTOM HID examples
  @{
  */
...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    USBD_ConfigPMA(&usbDeviceHandler, USBD_HID_EP_IN_ADDR, USBD_EP_BUFFER_SINGLE, USBD_HID_EP_IN_PMA_SIZE);
