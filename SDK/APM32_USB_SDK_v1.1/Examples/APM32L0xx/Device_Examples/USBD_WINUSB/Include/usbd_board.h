...
#define USBD_WINUSB_EP_OUT_ADDR             0x01
#define USBD_WINUSB_EP_OUT_PMA_SIZE         0x110

#define USBD_WINUSB_EP_IN_ADDR              0x81
#define USBD_WINUSB_EP_IN_PMA_SIZE          0xC0
