...
#include "apm32l0xx_usb_device.h"
...
void USBD_ClockInit(void)
{
    ...
    SYSCFG_EnableModuleBuffer(SYSCFG_MODULE_HSI48);

    RCM_EnableHSI48();
    RCM_ConfigHSI48Clock(RCM_HSI48_SEL_HSI48);
...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB_EP_OUT_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB_EP_OUT_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB_EP_IN_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB_EP_IN_PMA_SIZE);
