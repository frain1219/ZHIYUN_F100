...
/** @defgroup OTGH_HID_Variables Variables
  @{
  */

USBH_HANDLE_T usbHostHandler;

/**@} end of group OTGH_HID_Variables*/

/** @defgroup OTGH_HID_Functions Functions
  @{
  */
...
void USBH_HardwareInit(USBH_INFO_T* usbInfo)
{
    ...
    usbHostHandler.usbCfg.speed               = USB_SPEED_FSLS;
...
/**@} end of group OTGH_HID_Functions */
