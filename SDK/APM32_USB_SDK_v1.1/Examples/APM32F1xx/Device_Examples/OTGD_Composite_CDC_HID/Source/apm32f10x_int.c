...
/** @defgroup OTGD_Composite_CDC_HID_INT_Variables INT_Variables
  @{
  */

extern USBD_HANDLE_T usbDeviceHandler;

/**@} end of group OTGD_Composite_CDC_HID_INT_Variables */

/** @defgroup OTGD_Composite_CDC_HID_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group OTGD_Composite_CDC_HID_INT_Functions */
