...
uint8_t USBD_WINUSB_IN_EP_ADDR[USBD_WINUSB_NUM] = {USBD_WINUSB1_IN_EP_ADDR, USBD_WINUSB2_IN_EP_ADDR};
uint8_t USBD_WINUSB_OUT_EP_ADDR[USBD_WINUSB_NUM] = {USBD_WINUSB1_OUT_EP_ADDR, USBD_WINUSB2_OUT_EP_ADDR};
...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    /* Configure TX FIFO */
    USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 0, USBD_FS_EP0_FIFO_SIZE);
    USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 1, USBD_FS_EP1_FIFO_SIZE);
    USBD_OTG_ConfigDeviceTxFifo(&usbDeviceHandler, 2, USBD_FS_EP2_FIFO_SIZE);
...
void USBD_HardwareReset(USBD_INFO_T* usbInfo)
{
    ...
    {
        RCM_DisableAHBPeriphClock(RCM_AHB_PERIPH_OTG_FS);
