...
/** @addtogroup USBD_MSC_LowPower
  @{
  */

/** @defgroup USBD_MSC_LowPower_Macros Macros
  @{
*/

#define USBD_GEEHY_VID              12619
#define USBD_FS_PID                 0x109
#define USBD_LANGID_STR             0x0409
#define USBD_MANUFACTURER_STR       "Geehy"
#define USBD_PRODUCT_STR            "APM32 Mass Storage"
#define USBD_CONFIGURATION_STR      "MSC Config"
#define USBD_INTERFACE_STR          "MSC Interface"

/**@} end of group USBD_MSC_LowPower_Macros*/

/** @defgroup USBD_MSC_LowPower_Functions Functions
  @{
  */
...
/**@} end of group USBD_MSC_LowPower_Functions */

/** @defgroup USBD_MSC_LowPower_Structures Structures
  @{
  */
...
/**@} end of group USBD_MSC_LowPower_Structures*/

/** @defgroup USBD_MSC_LowPower_Variables Variables
  @{
  */
...
/**@} end of group USBD_MSC_LowPower_Variables*/
...
/**@} end of group USBD_MSC_LowPower_Functions */
/**@} end of group USBD_MSC_LowPower */
