...
/** @defgroup USBD_MSC_LowPower_INT_Variables INT_Variables
  @{
  */

extern USBD_HANDLE_T usbDeviceHandler;

/**@} end of group USBD_MSC_LowPower_INT_Variables */

/** @defgroup USBD_MSC_LowPower_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group USBD_MSC_LowPower_INT_Functions */
