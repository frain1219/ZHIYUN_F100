...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB1_IN_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB1_IN_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB1_OUT_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB1_OUT_EP_PMA_SIZE);

    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB2_IN_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB2_IN_EP_PMA_SIZE);
    USBD_ConfigPMA(&usbDeviceHandler, USBD_WINUSB2_OUT_EP_ADDR, USBD_EP_BUFFER_SINGLE, USBD_WINUSB2_OUT_EP_PMA_SIZE);
