...
#ifndef _USBD_COMPOSITE_MSC_BOT_H_
#define _USBD_COMPOSITE_MSC_BOT_H_
...
/** @defgroup OTGD_Composite_MSC_WINUSB_Enumerates Enumerates
  @{
  */
...
/**@} end of group OTGD_Composite_MSC_WINUSB_Enumerates*/
