...
/** @addtogroup OTGD_WINUSB
  @{
  */

/** @defgroup OTGD_WINUSB_Macros Macros
  @{
*/

#define USBD_GEEHY_VID              12619
#define USBD_FS_PID                 0x124
#define USBD_LANGID_STR             0x0409
#define USBD_MANUFACTURER_STR       "Geehy"
#define USBD_PRODUCT_STR            "APM32 WINUSB"
#define USBD_CONFIGURATION_STR      "WINUSB Config"
#define USBD_INTERFACE_STR          "WINUSB Interface"

/**@} end of group OTGD_WINUSB_Macros*/

/** @defgroup OTGD_WINUSB_Functions Functions
  @{
  */
...
/**@} end of group OTGD_WINUSB_Functions */

/** @defgroup OTGD_WINUSB_Structures Structures
  @{
  */
...
/**@} end of group OTGD_WINUSB_Structures*/

/** @defgroup OTGD_WINUSB_Variables Variables
  @{
  */
...
uint8_t USBD_ConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    ...
    USBD_DESC_ENDPOINT,
    /* bEndpointAddress */
    USBD_WINUSB_DATA_OUT_EP_ADDR,
    /* bmAttributes */
    0x02,
    /* wMaxPacketSize: */
    USBD_WINUSB_FS_MP_SIZE & 0xFF,
    USBD_WINUSB_FS_MP_SIZE >> 8,
    /* bInterval: */
    0x00,
...
uint8_t USBD_DevQualifierDesc[USBD_DEVICE_QUALIFIER_DESCRIPTOR_SIZE] =
{
    ...
    0x00,
    0x00,
    USBD_WINUSB_FS_MP_SIZE, /* In FS device*/
    0x01,
    0x00,
};

/**@} end of group OTGD_WINUSB_Variables*/
