...
uint8_t USBD_ConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    ...
    0x08,                                             /* bLength: Interface Descriptor size */
    USBD_DESC_IAD,                                    /* bDescriptorType: */
    USBD_CDC_CTRL_INTERFACE_NUM,                      /* bFirstInterface */
    USBD_CDC_INTERFACE_CNT,                           /* bInterfaceCount */
