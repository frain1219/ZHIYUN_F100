...
/** @addtogroup USBD_Composite_HID_MSC
  @{
  */

/** @defgroup USBD_Composite_HID_MSC_Variables Variables
  @{
  */

USBD_HANDLE_T usbDeviceHandler;

/**@} end of group USBD_Composite_HID_MSC_Variables*/

/** @defgroup USBD_Composite_HID_MSC_Functions Functions
  @{
  */
...
/**@} end of group USBD_Composite_HID_MSC_Functions */
/**@} end of group USBD_Composite_HID_MSC */
