...
/** @defgroup USBD_Composite_HID_MSC_INT_Variables INT_Variables
  @{
  */

extern USBD_HANDLE_T usbDeviceHandler;

/**@} end of group USBD_Composite_HID_MSC_INT_Variables */

/** @defgroup USBD_Composite_HID_MSC_INT_Functions INT_Functions
  @{
  */
...
/**@} end of group USBD_Composite_HID_MSC_INT_Functions */
