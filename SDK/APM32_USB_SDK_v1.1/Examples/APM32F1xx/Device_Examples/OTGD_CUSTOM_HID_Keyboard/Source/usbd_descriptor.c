...
/** @addtogroup Examples
  * @brief OTGD CUSTOM HID Keyboard examples
  @{
  */

/** @addtogroup OTGD_CUSTOM_HID_Keyboard
  @{
  */

/** @defgroup OTGD_CUSTOM_HID_Keyboard_Macros Macros
  @{
*/

#define USBD_GEEHY_VID              12619
#define USBD_FS_PID                 0x107
#define USBD_LANGID_STR             0x0409
#define USBD_MANUFACTURER_STR       "Geehy"
#define USBD_PRODUCT_STR            "APM32 HID"
#define USBD_CONFIGURATION_STR      "HID Config"
#define USBD_INTERFACE_STR          "HID Interface"

/**@} end of group OTGD_CUSTOM_HID_Keyboard_Macros*/

/** @defgroup OTGD_CUSTOM_HID_Keyboard_Functions Functions
  @{
  */
...
/**@} end of group OTGD_CUSTOM_HID_Keyboard_Functions */

/** @defgroup OTGD_CUSTOM_HID_Keyboard_Structures Structures
  @{
  */
...
{
    "Custom HID Keyboard Descriptor",
...
/**@} end of group OTGD_CUSTOM_HID_Keyboard_Structures*/

/** @defgroup OTGD_CUSTOM_HID_Keyboard_Variables Variables
  @{
  */
...
uint8_t USBD_ConfigDesc[USBD_CONFIG_DESCRIPTOR_SIZE] =
{
    ...
    0x03,
    /* wMaxPacketSize: */
    USBD_CUSTOM_HID_OUT_EP_ADDR & 0xFF,
    USBD_CUSTOM_HID_OUT_EP_ADDR >> 8,
    /* bInterval: */
...
/**@} end of group OTGD_CUSTOM_HID_Keyboard_Variables*/
...
/**@} end of group OTGD_CUSTOM_HID_Keyboard_Functions */
/**@} end of group OTGD_CUSTOM_HID_Keyboard */
