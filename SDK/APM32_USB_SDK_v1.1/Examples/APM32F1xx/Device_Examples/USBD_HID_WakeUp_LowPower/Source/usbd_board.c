...
void USBD_HardwareInit(USBD_INFO_T* usbInfo)
{
    ...
    if (usbDeviceHandler.usbCfg.lowPowerStatus == ENABLE)
    {
        ...
        USBD_FS_WAKEUP_EINT_ENABLE_RISING_EDGE();
        USBD_FS_WAKEUP_EINT_ENABLE_IT();
    ...
    USBD_ConfigPMA(&usbDeviceHandler, USBD_HID_WakeUp_LowPower_EP_IN_ADDR, USBD_EP_BUFFER_SINGLE, USBD_HID_WakeUp_LowPower_EP_IN_SIZE);
