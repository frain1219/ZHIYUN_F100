...
/** @defgroup USBD_HID_WakeUp_LowPower_Structures Structures
  @{
  */
...
/**@} end of group USBD_HID_WakeUp_LowPower_Structures*/

/** @defgroup USBD_HID_WakeUp_LowPower_Variables Variables
  @{
  */
...
/**@} end of group USBD_HID_WakeUp_LowPower_Variables*/
