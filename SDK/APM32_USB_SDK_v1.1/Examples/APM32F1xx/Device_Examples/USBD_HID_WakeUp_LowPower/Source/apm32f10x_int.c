...
/** @defgroup USBD_HID_WakeUp_LowPower_INT_Variables INT_Variables
  @{
  */
...
/**@} end of group USBD_HID_WakeUp_LowPower_INT_Variables */

/** @defgroup USBD_HID_WakeUp_LowPower_INT_Functions INT_Functions
  @{
*/
...
/**@} end of group USBD_HID_WakeUp_LowPower_INT_Functions */
