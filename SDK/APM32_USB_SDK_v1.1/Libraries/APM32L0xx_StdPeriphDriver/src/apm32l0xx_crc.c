...
void CRC_Reset(void)
{
    RCM_EnableAHBPeriphReset(RCM_AHB_PERIPH_CRC);
    RCM_DisableAHBPeriphReset(RCM_AHB_PERIPH_CRC);
}
...
{
    CRC->CTRL_B.POLSEL = polynomialSize;
}
