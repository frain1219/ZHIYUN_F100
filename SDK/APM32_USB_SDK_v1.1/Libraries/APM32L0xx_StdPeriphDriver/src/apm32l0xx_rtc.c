...
{
    /** ALRMA Time Settings : Time = 00h:00min:00sec */
    timeStruct->hours = 0;
...
void RTC_ReadTime(RTC_FORMAT_T format, RTC_TIME_T* timeStruct)
{
    ...
    timeStruct->h12 = (RTC_H12_T)((temp & 0x00400000) >> 22);
...
{
    alarmConfig->time.hours = 1;
    alarmConfig->time.minutes = 2;
    alarmConfig->time.seconds = 3;
    alarmConfig->time.h12 = RTC_H12_AM;
...
void RTC_ReadAlarm(RTC_FORMAT_T format, RTC_ALARM_T alarm, RTC_AlarmConfig_T* alarmConfig)
{
    ...
    if (alarm == RTC_ALARM_A)
    {
        ...
        alarmConfig->time.h12     = (uint8_t)(RTC->ALRMA_B.TIMEFCFG);
    ...
    else
    {
        ...
        alarmConfig->time.minutes = (uint8_t)(minutes_d | minutes_u);
        alarmConfig->time.seconds = (uint8_t)(seconds_d | seconds_u);
        alarmConfig->time.h12     = (uint8_t)(RTC->ALRMB_B.TIMEFCFG);
        alarmConfig->alarmDateWeekDay = (uint8_t)(day_d | day_u);
 ...
 * @retval      None
 *
 * @note        It's only for APM32L072 device
 */
 ...
 */
void RTC_ConfigWakeUpValue(uint32_t wakeUpValue)
{
    RTC_DisableWriteProtection();
 ...
 *                     @arg RTC_OPSEL_ALARMB
*                      @arg RTC_OPSEL_WAKEUP: available only for APM32L072 device
 *
...
void RTC_ReadTimeDate(RTC_FORMAT_T format, RTC_TIME_T* timeStruct, RTC_DATE_T* dateStruct)
{
    ...
    timeStruct->h12 = (RTC_H12_T)((temptime & 0x00400000) >> 22);
 ...
 *                       @arg RTC_TAMPER_3: Select Tamper 3. (Only for APM32L072 device)
 *
 ...
 *                    This parameter can be one of the following values:
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV32768: Each of the tamper inputs are sampled
 *                                                         with a frequency =  RTCCLK / 32768
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV16384: Each of the tamper inputs are sampled
 *                                                         with a frequency =  RTCCLK / 16384
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV8192: Each of the tamper inputs are sampled
 *                                                      with a frequency =  RTCCLK / 8192
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV4096: Each of the tamper inputs are sampled
 *                                                        with a frequency =  RTCCLK / 4096
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV2048: Each of the tamper inputs are sampled
 *                                                        with a frequency =  RTCCLK / 2048
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV1024: Each of the tamper inputs are sampled
 *                                                        with a frequency =  RTCCLK / 1024
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV512: Each of the tamper inputs are sampled
 *                                                       with a frequency =  RTCCLK / 512
 *                    @arg RTC_TAMPER_SAMPLING_FREQ_RTCCLK_DIV256: Each of the tamper inputs are sampled
 ...
 *                    This parameter can be one of the following values:
 *                    @arg RTC_PRECHARGE_DURATION_1RTCCLK: Tamper pins are pre-charged before sampling during 1 RTCCLK cycle
 *                    @arg RTC_PRECHARGE_DURATION_2RTCCLK: Tamper pins are pre-charged before sampling during 2 RTCCLK cycle
 *                    @arg RTC_PRECHARGE_DURATION_4RTCCLK: Tamper pins are pre-charged before sampling during 4 RTCCLK cycle
 *                    @arg RTC_PRECHARGE_DURATION_8RTCCLK: Tamper pins are pre-charged before sampling during 8 RTCCLK cycle
 *
 * @retval      None
 */
...
{
    RTC->OPT_B.RTC_ALARM_OUT = output;
}
 ...
 *                        @arg RTC_INT_WT:   WakeUp Timer interrupt mask(only APM32L072 device)
 ...
 *                       This parameter can be any combination of the following values:
 *                        @arg RTC_INT_ALRA: ALRMA A interrupt mask
 *                        @arg RTC_INT_ALRB: ALRMA B interrupt mask
 *                        @arg RTC_INT_WT:   WakeUp Timer interrupt mask(only APM32L072 devices)
 *                        @arg RTC_INT_TS:   Time Stamp interrupt mask
 *                        @arg RTC_INT_TAMP: Tamper event interrupt mask
 *
 * @retval    None
 ...
 *                  @arg RTC_FLAG_WTF  (only APM32L072 device)
 *                  @arg RTC_FLAG_TSF
 *                  @arg RTC_FLAG_TSOF
 *                  @arg RTC_FLAG_TP1F
 *                  @arg RTC_FLAG_TP2F
 *                  @arg RTC_FLAG_TP3F  (only APM32L072 device)
 *                  @arg RTC_FLAG_RPF
 ...
 *                  This parameter can be any combination of the following values:
 *                  @arg RTC_FLAG_TP3F: Tamper 3 event flag (only APM32L072 device)
 ...
 *                  @arg RTC_FLAG_WTF : WakeUp Timer flag  (only APM32L072 device)
 *                  @arg RTC_FLAG_ALRAF: Alarm A Flag
 *                  @arg RTC_FLAG_ALRBF: Alarm B Flag
 ...
 *                  @arg RTC_INT_FLAG_WT: WakeUp Timer interrupt (only APM32L072 device)
 *                  @arg RTC_INT_FLAG_TAMP1: Tamper1 event interrupt
 *                  @arg RTC_INT_FLAG_TAMP2: Tamper2 event interrupt
 *                  @arg RTC_INT_FLAG_TAMP3: Tamper3 event interrupt  (only APM32L072 device)
