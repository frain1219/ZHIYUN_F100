...
/*!
 * @brief  Reload Frequency Error Counter Value
 *
 ...
 *                       @arg CRS_INT_SNFLG    : SYNC event OK interrupt
 *                       @arg CRS_INT_SWFLG    : SYNC warning interrupt
 *                       @arg CRS_INT_EFLG     : Synchronization or trimming error interrupt
 *                       @arg CRS_INT_ESFLG    : Expected SYNC interrupt
 *
 * @retval   None
 */
 ...
 *                 This parameter can be one of the following values:
 *                     @arg CRS_FLAG_SNFLG    : SYNC event OK flag
 *                     @arg CRS_FLAG_SWFLG    : SYNC warning flag
 *                     @arg CRS_FLAG_EFLG     : Synchronization or trimming error flag
 *                     @arg CRS_FLAG_ESFLG    : Expected SYNC flag
 *                     @arg CRS_FLAG_ERRORFLG : SYNC error flag
 *                     @arg CRS_FLAG_SYNCMISS : SYNC missed flag
 *                     @arg CRS_FLAG_TRMFLG   : Trimming overflow or underflow falg
 *
 ...
 *                       @arg CRS_INT_EFLG     : Synchronization or trimming error interrupt
 *                       @arg CRS_INT_ESFLG    : Expected SYNC interrupt
 *                       @arg CRS_INT_ERRORFLG : SYNC error
 *                       @arg CRS_INT_SYNCMISS : SYNC missed
 *                       @arg CRS_INT_TRMFLG   : Trimming overflow or underflow
 *
 * @retval   The new state of CRS_INT (SET or RESET).
 */
