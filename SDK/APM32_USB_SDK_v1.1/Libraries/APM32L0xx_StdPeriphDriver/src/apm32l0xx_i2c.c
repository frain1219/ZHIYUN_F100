 ...
 *
 * @param     i2c: Select I2C peripheral,it can be I2C1/I2C2/I2C3.
 *
 * @retval    None
 */
 ...
 *
 * @param       i2c:   Select I2C peripheral, It can be I2C1/I2C3.
 *
 * @retval      None
 *
 */
...
{
    i2c->INTFCLR_B.ADDRMCLR = BIT_SET;
}
...
/*!
 * @brief       Disable I2C communication Acknowledge
 *
 * @param       i2c: Select I2C peripheral,it can be I2C1/I2C2/I2C3.
 *
 * @retval      None
...
uint16_t I2C_ReadTransferDirection(I2C_T* i2c)
{
    ...
    {
        direction = (uint16_t)(I2C_DIRECTION_RX);
    }
...
/*!
 * @brief       Enables I2C  Transfer Packet Error(PEC) Checking Byte
 *
 * @param       i2c: Select I2C peripheral,it can be I2C1/I2C3.
 *
 * @retval      None
