...
/*!
 * @brief       Set counter Window value
 *
 * @param       windowValue: Specifies the ounter Window value
 *
 * @retval      None
 */
 ...
 *              The parameter can be one of following values:
 *                 @arg IWDT_FLAG_PSCUFLG:   Watchdog prescaler value update
 *                 @arg IWDT_FLAG_CNTUFLG:   Watchdog counter reload value update
 *                 @arg IWDT_FLAG_CNTWUFLG:  Watchdog counter window value update
 *
