...
static const ProbePinDef g_probe_pins[] = {
    ...
    {"PG7", GPIOG, GPIO_PIN_7, PROBE_PIN_MONITOR_ONLY, false, "F103 PB7 encoder B"},
    {"PF7", GPIOF, GPIO_PIN_7, PROBE_PIN_INJECTABLE, false, "F103 PB12 aux"},
    {"PF8", GPIOF, GPIO_PIN_8, PROBE_PIN_INJECTABLE, false, "F103 PB13 aux/stat"},
    {"PF9", GPIOF, GPIO_PIN_9, PROBE_PIN_INJECTABLE, false, "F103 PB14 MP3398 EN"},
    {"PF10", GPIOF, GPIO_PIN_10, PROBE_PIN_INJECTABLE, false, "F103 PB15 MP3398 ADIM"},
    {"PF11", GPIOF, GPIO_PIN_11, PROBE_PIN_INJECTABLE, false, "F103 PA8 W_PWM"},
    {"PF12", GPIOF, GPIO_PIN_12, PROBE_PIN_INJECTABLE, false, "F103 PA9 C_PWM"},
    ...
    {"PF3", GPIOF, GPIO_PIN_3, PROBE_PIN_MONITOR_ONLY, true, "F103 PA3 ADC"},
    {"PF4", GPIOF, GPIO_PIN_4, PROBE_PIN_MONITOR_ONLY, true, "F103 PA4 ADC"},
    {"PF5", GPIOF, GPIO_PIN_5, PROBE_PIN_MONITOR_ONLY, true, "F103 PB0 ADC"},
    {"PF6", GPIOF, GPIO_PIN_6, PROBE_PIN_MONITOR_ONLY, true, "F103 PB1 ADC"},
    {"PF14", GPIOF, GPIO_PIN_14, PROBE_PIN_FORBIDDEN_DRIVE, false, "F103 SWDIO"},
    {"PF15", GPIOF, GPIO_PIN_15, PROBE_PIN_FORBIDDEN_DRIVE, false, "F103 SWCLK"},
};
