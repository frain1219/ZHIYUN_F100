...
target extended-remote localhost:4335
if 1 == 1
...
set {unsigned char}0x200008c8 = 0
set {unsigned int}0x2000051c = 1
set {unsigned int}0x20000854 = 0
...
set $flush_trigger_before = *((unsigned int*)0x20000888)
set $flush_skip_before = *((unsigned int*)0x20000880)
set $flush_rehit_left = 0
while ($flush_rehit_left > 0) && (*((unsigned int*)0x20000888) == $flush_trigger_before) && (*((unsigned int*)0x20000880) == $flush_skip_before)
  continue
...
echo === Flush breakpoint snapshot (rehit+post-step 24) ===\n
info registers pc sp lr
x/1wx 0x20000548
x/1wx 0x20000888
x/1wx 0x20000880
