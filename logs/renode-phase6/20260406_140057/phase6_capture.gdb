...
shell sleep 2
interrupt
echo === Stimulate USB insert via SRAM event injection ===\n
set {unsigned char}(0x2000055c + 9) = 1
set {unsigned char}0x20000568 = 1
monitor start
shell sleep 2
interrupt
...
x/1wx 0x40000824
dump binary memory /Users/milocheung/Documents/codeProject/ZHIYUN_F100/logs/renode-phase6/20260406_140057/phase6_sram_20k.bin 0x20000000 0x20005000
detach
quit
