...
set $flush_trigger_before = *((unsigned int*)0x200008a8)
set $flush_skip_before = *((unsigned int*)0x200008a0)
set $flush_rehit_left = 0
while ($flush_rehit_left > 0) && (*((unsigned int*)0x200008a8) == $flush_trigger_before) && (*((unsigned int*)0x200008a0) == $flush_skip_before)
  continue
