...
set {unsigned char}(0x20000514 + 6) = 1
set {unsigned char}(0x20000514 + 7) = 1
set {unsigned char}(0x20000514 + 8) = 1
set {unsigned char}(0x20000514 + 9) = 1
set {unsigned char}(0x20000514 + 10) = 1
set {unsigned char}(0x20000514 + 11) = 1
set {unsigned char}0x200004dc = 1
...
x/1wx 0x40000824
dump binary memory /Users/milocheung/Documents/codeProject/ZHIYUN_F100/logs/renode-phase6/20260406_140209/phase6_sram_20k.bin 0x20000000 0x20005000
detach
quit
