...
set $bp_flush = $bpnum
hbreak *UI_SPI1_PumpEightFramebufferSlices+0x84
set $bp_flush_post_trigger = $bpnum
hbreak *UI_SPI1_PumpEightFramebufferSlices+0xa8
...
set $r1 = 0
set $r3 = 1
echo === Force flush branch registers patched: SKIP (r0=0,r1=0,r3=1) ===\n
if 0 == 1
